...
def test():
    ...
    # 源数据路径
    path = "240623/data3.csv"
    cali_path = "240623/gyro_cali.csv"
    mag_path = "240623/mag_cali.csv"
    opti_file_path = "240623/opt/opt3.csv"
    # 读入imu原始数据
    ...
    show_angles(pitch, roll, yaw, time, "Pressure")
